      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link" href="main.html" style="color:white; background-color:rgb(128, 98, 61); border-radius: 20px; padding-bottom: 1px; padding-top: 2px;">HOME</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="cart" href="#" style="margin-left: 15px; margin-right: 15px;">
                <img src="Design Elements\icons\cart-fill.svg" alt="Cart-Icon" height="35px">
              </a>
            </li>
          </ul>
        </div>
